...
# MPI-272: media inputs migrated to path-into-string MpiLoadImageFromPath nodes
# that self-gate on an empty `string` — no placeholder staging or stamping needed.
