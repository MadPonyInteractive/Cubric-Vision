...
If you are asked to perform a task in any of the following categories, you MUST use the `cat` or `read` tool to ingest the respective rule file first.
...
### 🗺️ Workspace & Routing Architecture
...
👉 **MUST READ:** Do NOT parse the entire file, but use your terminal or tools to read the **last 50-100 lines of `logs/app.log`**. This is the master terminal output and contains runtime telemetry.
