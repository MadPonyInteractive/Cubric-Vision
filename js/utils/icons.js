...
export const ICONS = {
    ...
    'mask_bw': '<path fill-rule="evenodd" d="M4 4h16v16H4V4zm2 2v12h6V6H6z"/>',
    ...
    'merge': '<path d="M6.41 21L5 19.59l4.83-4.83c.75-.75 1.17-1.77 1.17-2.83v-5.1L9.41 8.41 8 7l4-4 4 4-1.41 1.41L13 6.83v5.1c0 1.06.42 2.08 1.17 2.83L19 19.59 17.59 21 13 16.41V21h-2v-4.59L6.41 21z"/>',
    ...
    'laptop': '<path d="M20 18c1.1 0 1.99-.9 1.99-2L22 5c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2H0v2h24v-2h-4zM4 5h16v11H4V5z"/>',
