...
export const RELEASE_NOTES = {
  '1.4.0': {
    ...
    engineNotes: [
      'COMFYUI ENGINE UPDATED TO 0.30.0 - from 0.29.2. Every shipped model was re-swept after the update by executing a real generation for each of its operations on a GPU, 35 in total, and all of them passed.',
    ],
  },
  '1.3.1': {
    version: '1.3.1',
