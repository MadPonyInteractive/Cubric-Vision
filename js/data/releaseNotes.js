...
export const RELEASE_NOTES = {
  '1.1.0': {
    ...
    whatIsNew: [
      ...
      'LTX 2.3 — a fast video model that generates with sound: produce an audio track or drive it from your own clip. Does text-to-video and image-to-video with first and last-frame guidance, up to 2K and 4K. Quality tier is remembered per model.',
