...
export const DEPS = {
    ...
    'ltx23-transformer': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/diffusion_models/ltx-2.3-22b-distilled-1.1_transformer_only_bf16.safetensors',
        size: '41GB',
        vram: '12GB',
    ...
    'ltx23-video-vae': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/vae/LTX23_video_vae_bf16.safetensors',
        size: '1.45GB',
    ...
    'ltx23-audio-vae': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/vae/LTX23_audio_vae_bf16.safetensors',
        size: '370MB',
    ...
    'ltx23-text-projection': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/text_encoders/ltx-2.3_text_projection_bf16.safetensors',
        size: '2.31GB',
    ...
    'ltx23-gemma-clip': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/text_encoders/gemma-3-12b-it-heretic-fp8-comfy.safetensors',
        size: '14.5GB',
    ...
    'ltx23-spatial-upscaler': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/latent_upscale_models/ltx-2.3-spatial-upscaler-x2-1.1.safetensors',
        size: '1.5GB',
    ...
    'ltx23-lora-soft-enhance': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/loras/LTX2.3_Soft_Enhance.safetensors',
        size: '344MB',
    ...
    'ltx23-lora-transition': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/loras/ltx2.3-transition.safetensors',
        size: '372MB',
    ...
    'ltx23-lora-talkvid': {
        ...
        url: 'https://dl.cubric.studio/models/ltx-2.3/loras/ltx-2.3-id-lora-talkvid-3k.safetensors',
        size: '1.1GB',
