...
### GitHub Discussions — feature request canonical surface

  - tags: [feature, github, community, workflow]
  - priority: high
...
### In-app error reporter — stage-aware GitHub Issues routing

  - tags: [feature, telemetry, bug-tracking]
  - priority: high
  - defaultExpanded: false
    ```md
    Cross-repo work from MPI Discord revamp session (2026-05-29).
