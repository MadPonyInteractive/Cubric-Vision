...
description: Run an ESLint audit on js/components/ and report violations in markdown table format. Groups violations by rule ID and file. Does NOT fix — reports only.
user-invocable: true
---
