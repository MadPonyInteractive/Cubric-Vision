...
SHIPPED=$(grep -oE "^const POD_IMAGE_VERSION\s*=\s*'v[0-9.]+'" routes/remotePodLifecycle.js | grep -oE "v[0-9.]+")  # <- the tag the app currently points at; read it live so this never drifts (e.g. v0.14.0). keep it
