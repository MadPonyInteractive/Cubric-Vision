...
- `MpiButton` (cogwheel — parameters popup trigger, MPI-356)   props: `{ icon:'settings', variant:'ghost', size:'sm', info:'Generation parameters' }`   slot: `#settings-cog-slot`
