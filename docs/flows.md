...
| MpiBaseFlow / MpiFlowLibrary, a Ready tile skipping the drawer, install progress, Ctrl+Enter, overlay z-order + status bar, dev-gate | [04-overlay-and-shell.md](playbooks/add-flow/04-overlay-and-shell.md) |
| The result pane: `result.compare`, the video player, surviving close -> reopen | [ui/result-pane.md](playbooks/add-flow/ui/result-pane.md) |
