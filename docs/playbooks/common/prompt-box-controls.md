...
| `'perModel'` | `project.modelSettings[id]` (model-WIDE) | a MODE the user works in, held across the model's ops | `qualityTier`, `qwenTier`, `styleSelect`, `stylization`, `krea2Turbo` |
